...
import { timelineItems, updateTimelineItemActivitySeconds } from '../timeline-items'
...
<template>
  <div class="flex w-full gap-2">
    ...
    <div class="flex items-center flex-grow bg-gray-100 rounded px-2 font-mono text-3xl">
